...
function AllEmployes() {
  ...
  // robust check for "active" check-in status
  ...
  // handle row click → go to employee check-in details
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="bg-gray-100 text-gray-700 border-b border-gray-300">
                <th className="py-3 px-4 text-center border-r border-gray-300 w-16">
                  S.No
                </th>
                <th className="py-3 px-4 border-r border-gray-300 text-left">
                  Name
                </th>
                <th className="py-3 px-4 border-r border-gray-300 text-left">
                  Email
              ...
              {employees.map((emp, index) => {
                ...
                return (
                  <tr
                    ...
                    onClick={() => handleViewHistory(emp._id)} // ✅ fixed here
                    className="hover:bg-gray-100 border-b border-gray-200 transition-colors cursor-pointer"
                  >
